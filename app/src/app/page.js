...
export default function Home() {
  ...
  const toggleStats = () => setShowStatistics(!showStatistics);
  ...
  return (
    <div className="container mx-auto max-w-[1536px] overflow-hidden motion-preset-fade motion-duration-2000 motion-delay-[1000ms]">
