...
> Use the MongoDB MCP Server configured in Cline to describe the structure and main fields of the listingsAndReviews collection in my database. List all the databases and collections available to me first.
